...
<div>
    <table class="table">
        ...
        <%
            ...
            try{
                String searach = (String) session.getAttribute("searchByDepartment");

                Class.forName(dbdriver);
                Connection conn=DriverManager.getConnection(url+dbName,dbuserName,dbpassword);
                Statement st=conn.createStatement();

                String sql = "select b.booklistID,b.bookname,b.author,b.isbn,b.description,b.department,u.userID,u.userTitle,u.surname,u.email,b.bookcondition,l.locationName,b.sellorlend,b.price from booklist b,location l, userprofile u where department = '"+searach+"'and b.locationID=l.locationID and b.userID=u.userID";
